...
import { getUser } from "./components/api/info";
...
function App() {
  ...
  //         actualizarNombre();
  //       tabletHomeDashboardData.welcome = `Hello ${response[0]["firstName"]}, welcome back!`;
  //       mobileHomeDashboardData.welcome = `Hello ${response[0]["firstName"]}, welcome back!`;
  //       desktopMyProfileData.welcome = `Hello ${response[0]["firstName"]}, welcome back!`;
  //       desktopDashboardData.welcome = `Hello ${response[0]["firstName"]}, welcome back!`;
  //       tabletDashboardData.welcome = `Hello ${response[0]["firstName"]}, welcome back!`;
  //       mobileDashboardData.welcome = `Hello ${response[0]["firstName"]}, welcome back!`;
  //     })();
  //   }, []);
  return (
    <Router>
      <Switch>
        ...
        <Route path="/mobile-my-sales">
          <MobileMySales
            ...
            title22Props={mobileMySalesData.title22Props}
          />
        </Route>
        ...
        <Route path="/desktop-transfer-good">
          <DesktopTransferGood
            ...
            addNewCardPopup2Props={
              desktopTransferGoodData.addNewCardPopup2Props
            }
          />
        </Route>
        ...
        <Route path="/mobile-upload-avatar">
          <MobileUploadAvatar
            ...
            buttonWithdrawAllEarningProps={
              mobileUploadAvatarData.buttonWithdrawAllEarningProps
            }
          />
        </Route>
        ...
        <Route path="/tablet-edit-cell-number">
          <TabletEditCellNumber
            group21Props={tabletEditCellNumberData.group21Props}
          />
        </Route>
...
function actualizarNombre() {
  desktopDashboardData.welcome = "hola mundo";
}
...
const desktopHomeDashboardData = {
  ...
  name: (
    <React.Fragment>
      Cash out rewards to dollars when you
      <br />
      reach 50 - or spend on products now.
    </React.Fragment>
  ),
...
const tabletHomeDashboardData = {
  ...
  dashboard: "Focus Zone Portal",
  welcome: "Hello ${first_tabletHomedb}, welcome back!",
...
const mobileHomeDashboardData = {
  logo: "/static/img/welcometonls-black2-1@1x.png",
  dashboard: "Focus Zone Portal",
  welcome: "Hello ${mobile_home_db}, welcome back!",
  ...
  nulifespan_AllProductsOnStands1000W:
    "/static/img/nulifespan-all-products-on-stands1000w2@1x.png",
  onSale: "On Sale!",
  ongoing: "See what’s new …",
...
const mobileTransferGoodData = {
  ...
  beforeYouCanMake: (
    <React.Fragment>
      Before you can make a transfer/withdrawal, <br />
      Please make sure you have completed <br />
      the following steps.
    </React.Fragment>
  ),
  reachAMinimumOf: (
    <React.Fragment>
      • Reach a minimum of 50 points/dollars in <br />
      your available rewards cash balance.
    </React.Fragment>
  ),
...
const mobileTransferErrorData = {
  ...
  somethingIsNotQui: (
    <React.Fragment>
      Something is not quite right. Before you
      <br />
      can make a transfer/withdrawal, please
      <br />
  ...
  youHaveNotReach: (
    <React.Fragment>
      • You have not reached the minimum of 50 <br /> points/dollars in your
      available rewards <br /> cash balance.
    </React.Fragment>
  ),
  orAnErrorHasO: (
    <React.Fragment>
      OR
      <br />
      <br />• An error has occurred connecting your <br /> payment card . Please
      visit the FAQ page
      <br /> to learn more.
    </React.Fragment>
  ),
...
const desktopDashboardData = {
  ...
  ongoing: "See what’s new …",
  dashboard: "Focus Zone Portal",
  welcome: "Hello ${desktopDB}, welcome back!",
  yourRewardsCash: "Your Rewards Cash",
  price: "$40.00",
  name: (
    <React.Fragment>
...
const tabletDashboardData = {
  ...
  users: "/static/img/vector-107@1x.png",
  dashboard: "Focus Zone Portal",
  welcome: "Hello ${tabletdb}, welcome back!",
...
const mobileDashboardData = {
  logo: "/static/img/welcometonls-black2-1@1x.png",
  dashboard: "Focus Zone Portal",
  welcome: "Hello ${mobile_db}, welcome back!",
  brandPartnerPresidentClub1: "BRAND PARTNER - PRESIDENT CLUB 1",
  overlapGroup1: "/static/img/background-11@1x.png",
  spanText1: (
    <React.Fragment>
